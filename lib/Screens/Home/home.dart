        ...
        child: SafeArea(
            ...
            children: [
              ...
              ListTile(
                ...
                onTap: (){
                  Navigator.of(context).push(MaterialPageRoute(builder:(context)=>addUniversity() ));
                },
        ...
        child: Column(
          children: [
              Padding(
                ...
                child: TextFormField(
                  onTap: ()async{
                  Unisnapshot   =await showSearch(context: context, delegate: universitySearch());
                  if(Unisnapshot!=null)
               ...
               Padding(
                ...
                child: TextFormField(
                    onTap: ()async{
                      Subsnapshot =await showSearch(context: context, delegate: subjectSerach());
                      if(Subsnapshot!=null)
              ...
              child: MaterialButton(onPressed: (){
                ...
                if(_university.text.isNotEmpty || _subject.text.isNotEmpty){
                  ...
                  ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text("Complete All Fields"),duration: Duration(milliseconds:500),));
                }
              },
              color: Colors.black,
  ...
  List<Widget> buildActions(BuildContext context) {
    ...
    Widget buildResults(BuildContext context) {
      ...
      return StreamBuilder<QuerySnapshot>(
        stream: FirebaseFirestore.instance.collection("Subjects").where("name",isEqualTo:query).snapshots(),
    ...
    Widget buildSuggestions(BuildContext context) {
     ...
     return StreamBuilder<QuerySnapshot>(
        stream: FirebaseFirestore.instance.collection("Subjects").where("name",isLessThanOrEqualTo: query).snapshots(),
        builder:(context,snap){
...
class universitySearch extends SearchDelegate<DocumentSnapshot>{
  ...
  List<Widget> buildActions(BuildContext context) {
    ...
    Widget buildResults(BuildContext context) {
      ...
      return  StreamBuilder<QuerySnapshot>(
        stream: FirebaseFirestore.instance.collection("University").where("name",isLessThanOrEqualTo: query).snapshots(),
        builder:(context,snap){
